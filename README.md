...
A: Constraint propagation is used to solve this problem by adding in the extra
   units of the diagonal to the existing row, column, and square units. By doing
   so, those subspaces are referred to when the elimination and choose-one strategies
   are employed during propagation to a solution.
